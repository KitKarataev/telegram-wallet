...
from api.db import get_supabase_admin  # CHANGED: Use admin client
...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        # CHANGED: Use admin client (bot webhook needs to write on behalf of users)
